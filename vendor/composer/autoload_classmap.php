...
return array(
    ...
    'Core\\Autoloader\\Loader' => $baseDir . '/core/Autoloader/Loader.php',
    'Core\\Components\\ComponentBase' => $baseDir . '/core/Components/ComponentBase.php',
    'Core\\Config\\BaseConfig' => $baseDir . '/core/Config/BaseConfig.php',
    'Core\\Console\\Command' => $baseDir . '/core/Console/Command.php',
    'Core\\Console\\Commands\\MakeController' => $baseDir . '/core/Console/Commands/MakeController.php',
    'Core\\Console\\Commands\\MakeMiddleware' => $baseDir . '/core/Console/Commands/MakeMiddleware.php',
    'Core\\Console\\Commands\\MakeModel' => $baseDir . '/core/Console/Commands/MakeModel.php',
    'Core\\Console\\Kernel' => $baseDir . '/core/Console/Kernel.php',
    'Core\\Controllers\\Controller' => $baseDir . '/core/Controllers/Controller.php',
    'Core\\Controllers\\ForbiddenController' => $baseDir . '/core/Controllers/ForbiddenController.php',
    'Core\\Controllers\\InternalController' => $baseDir . '/core/Controllers/InternalController.php',
    'Core\\Controllers\\NotAllowController' => $baseDir . '/core/Controllers/NotAllowController.php',
    'Core\\Controllers\\NotFoundController' => $baseDir . '/core/Controllers/NotFoundController.php',
    'Core\\Controllers\\ResourcesController' => $baseDir . '/core/Controllers/ResourcesController.php',
    'Core\\Database\\ModelBase' => $baseDir . '/core/Database/ModelBase.php',
    'Core\\Database\\QueryBuilder' => $baseDir . '/core/Database/QueryBuilder.php',
    'Core\\Debug\\Toolbar' => $baseDir . '/core/Debug/Toolbar.php',
    'Core\\Exceptions\\Handler' => $baseDir . '/core/Exceptions/Handler.php',
    'Core\\Http\\HttpManager' => $baseDir . '/core/Http/HttpManager.php',
    'Core\\Kernel' => $baseDir . '/core/Kernel.php',
    'Core\\Log\\Logger' => $baseDir . '/core/Log/Logger.php',
    'Core\\Middleware\\Api\\AuthMiddleware' => $baseDir . '/core/Middleware/Api/AuthMiddleware.php',
    'Core\\Middleware\\Api\\CorsMiddleware' => $baseDir . '/core/Middleware/Api/CorsMiddleware.php',
    'Core\\Middleware\\Api\\RateLimitMiddleware' => $baseDir . '/core/Middleware/Api/RateLimitMiddleware.php',
    'Core\\Middleware\\BaseMiddleware' => $baseDir . '/core/Middleware/BaseMiddleware.php',
    'Core\\Middleware\\DebugMiddleware' => $baseDir . '/core/Middleware/DebugMiddleware.php',
    'Core\\Middleware\\MiddlewareHandler' => $baseDir . '/core/Middleware/MiddlewareHandler.php',
    'Core\\Middleware\\Web\\AuthMiddleware' => $baseDir . '/core/Middleware/Web/AuthMiddleware.php',
    'Core\\Middleware\\Web\\CsrfMiddleware' => $baseDir . '/core/Middleware/Web/CsrfMiddleware.php',
    'Core\\Middleware\\Web\\SessionMiddleware' => $baseDir . '/core/Middleware/Web/SessionMiddleware.php',
    'Core\\Providers\\ServiceProvider' => $baseDir . '/core/Providers/ServiceProvider.php',
    'Core\\Security\\CSRF' => $baseDir . '/core/Security/CSRF.php',
    'Core\\Utils\\Email' => $baseDir . '/core/Utils/Email.php',
    'Core\\Utils\\FileManager' => $baseDir . '/core/Utils/FileManager.php',
    'Core\\Utils\\Upload' => $baseDir . '/core/Utils/Upload.php',
    ...
    'FastRoute\\BadRouteException' => $vendorDir . '/ksevendev/fast-route/src/BadRouteException.php',
    'FastRoute\\Cache' => $vendorDir . '/ksevendev/fast-route/src/Cache.php',
    'FastRoute\\Cache\\FileCache' => $vendorDir . '/ksevendev/fast-route/src/Cache/FileCache.php',
    'FastRoute\\Cache\\Psr16Cache' => $vendorDir . '/ksevendev/fast-route/src/Cache/Psr16Cache.php',
    'FastRoute\\ConfigureRoutes' => $vendorDir . '/ksevendev/fast-route/src/ConfigureRoutes.php',
    'FastRoute\\DataGenerator' => $vendorDir . '/ksevendev/fast-route/src/DataGenerator.php',
    'FastRoute\\DataGenerator\\CharCountBased' => $vendorDir . '/ksevendev/fast-route/src/DataGenerator/CharCountBased.php',
    'FastRoute\\DataGenerator\\GroupCountBased' => $vendorDir . '/ksevendev/fast-route/src/DataGenerator/GroupCountBased.php',
    'FastRoute\\DataGenerator\\GroupPosBased' => $vendorDir . '/ksevendev/fast-route/src/DataGenerator/GroupPosBased.php',
    'FastRoute\\DataGenerator\\MarkBased' => $vendorDir . '/ksevendev/fast-route/src/DataGenerator/MarkBased.php',
    'FastRoute\\DataGenerator\\RegexBasedAbstract' => $vendorDir . '/ksevendev/fast-route/src/DataGenerator/RegexBasedAbstract.php',
    'FastRoute\\Dispatcher' => $vendorDir . '/ksevendev/fast-route/src/Dispatcher.php',
    'FastRoute\\Dispatcher\\CharCountBased' => $vendorDir . '/ksevendev/fast-route/src/Dispatcher/CharCountBased.php',
    'FastRoute\\Dispatcher\\GroupCountBased' => $vendorDir . '/ksevendev/fast-route/src/Dispatcher/GroupCountBased.php',
    'FastRoute\\Dispatcher\\GroupPosBased' => $vendorDir . '/ksevendev/fast-route/src/Dispatcher/GroupPosBased.php',
    'FastRoute\\Dispatcher\\MarkBased' => $vendorDir . '/ksevendev/fast-route/src/Dispatcher/MarkBased.php',
    'FastRoute\\Dispatcher\\RegexBasedAbstract' => $vendorDir . '/ksevendev/fast-route/src/Dispatcher/RegexBasedAbstract.php',
    'FastRoute\\Dispatcher\\Result\\Matched' => $vendorDir . '/ksevendev/fast-route/src/Dispatcher/Result/Matched.php',
    'FastRoute\\Dispatcher\\Result\\MethodNotAllowed' => $vendorDir . '/ksevendev/fast-route/src/Dispatcher/Result/MethodNotAllowed.php',
    'FastRoute\\Dispatcher\\Result\\NotMatched' => $vendorDir . '/ksevendev/fast-route/src/Dispatcher/Result/NotMatched.php',
    'FastRoute\\Exception' => $vendorDir . '/ksevendev/fast-route/src/Exception.php',
    'FastRoute\\FastRoute' => $vendorDir . '/ksevendev/fast-route/src/FastRoute.php',
    'FastRoute\\GenerateUri' => $vendorDir . '/ksevendev/fast-route/src/GenerateUri.php',
    'FastRoute\\GenerateUri\\FromProcessedConfiguration' => $vendorDir . '/ksevendev/fast-route/src/GenerateUri/FromProcessedConfiguration.php',
    'FastRoute\\GenerateUri\\UriCouldNotBeGenerated' => $vendorDir . '/ksevendev/fast-route/src/GenerateUri/UriCouldNotBeGenerated.php',
    'FastRoute\\Route' => $vendorDir . '/ksevendev/fast-route/src/Route.php',
    'FastRoute\\RouteCollector' => $vendorDir . '/ksevendev/fast-route/src/RouteCollector.php',
    'FastRoute\\RouteHelper' => $vendorDir . '/ksevendev/fast-route/src/RouteHelper.php',
    'FastRoute\\RouteParser' => $vendorDir . '/ksevendev/fast-route/src/RouteParser.php',
    'FastRoute\\RouteParser\\Std' => $vendorDir . '/ksevendev/fast-route/src/RouteParser/Std.php',
